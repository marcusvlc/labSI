...
app.factory('todoListService', function() {
    ...
    , comentario: "William John Paul Gallagher, conhecido como Liam Gallagher, é um músico britânico.", ehFavorito: false, albuns: [{nome: "", imagem: "", ano: "", musicas:[], dono:""}], nota:"0"},
    ...
    , comentario: "Noel Thomas David Gallagher (Manchester, 29 de Maio de 1967) é um músico britânico.", ehFavorito: false, albuns: [], nota:"0"},
    ...
    , comentario: "Sir James Paul McCartney é um cantor, compositor, multi-instrumentista, empresário, produtor musical britânico. ", ehFavorito: false, albuns: [], nota:"0"}
    ];
